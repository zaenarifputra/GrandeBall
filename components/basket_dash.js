...
const Basket_dash = ({navigation}) => {
  return (
    <ImageBackground source={require('../assets/bg_dash_mat/bg_dash_basket.png')}>
      ...
      <TouchableOpacity onPress={()=> navigation.navigate('Sejarah_basket')}> 
      ...
      <TouchableOpacity onPress={()=> navigation.navigate('Teknik_basket')}>
      ...
      <TouchableOpacity onPress={()=> navigation.navigate('Peraturan_basket')}>
      ...
      <TouchableOpacity onPress={()=> navigation.navigate('Organisasi_basket')}>
