...
const Futsal_dash = ({navigation}) => {
  return (
    <ImageBackground source={require('../assets/bg_dash_mat/bg_dash_futsal.png')}>
      <TouchableOpacity onPress={()=> navigation.navigate('Home')}>
       <Image source={require('../assets/ic_back.png')} style={{marginStart:25, marginTop:25}}/>
      </TouchableOpacity>
      <Text style={{marginTop:15, marginStart:120, fontSize:30, fontWeight:'bold'}}>Futsal</Text>
      <TouchableOpacity onPress={()=> navigation.navigate('Sejarah_futsal')}>
      ...
      <TouchableOpacity onPress={()=> navigation.navigate('Teknik_futsal')}>
      ...
      <TouchableOpacity onPress={()=> navigation.navigate('Peraturan_futsal')}>
      ...
      <TouchableOpacity onPress={()=> navigation.navigate('Organisasi_futsal')}>
